...
export default function GestionProducto() {
    ...
    return (
        <PaperProvider theme={Dialog}>
            <View>
                <Text variant="displayLarge" style={{ textAlign: 'center' }}>Productos</Text>
                <Button mode='elevated' buttonColor='blue' textColor='white' style={{width:'170px',marginLeft:'5px',marginTop:'10px',marginBottom:'10px'}}>Nuevo Producto</Button>
                <DataTable>
                    <DataTable.Header>
                    ...
                    {productos.map((producto) => (
                        <DataTable.Row key={producto.id}>
                            <DataTable.Cell>{producto.id}</DataTable.Cell>
                            <DataTable.Cell>{producto.nombre}</DataTable.Cell>
                            <DataTable.Cell>{producto.categoria}</DataTable.Cell>
                            <DataTable.Cell>
                                <Portal>
